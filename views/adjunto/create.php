...
<div class="form-group">
        ...
        <?= Html::a('<i class="fa fa-history"></i> Consultar adjuntos',Yii::$app->request->baseUrl.'/adjunto/index',['class'=>'btn btn-primary','title'=>'Consultar Adjuntos']) ?>
        
 </div>

    <h1>Agregar Adjunto</h1>
