...
<div class="ccosto-create">
    ...
    <?= Html::a('<i class="fa fa-arrow-left"></i>',Yii::$app->request->baseUrl.'/visita/update?id='.$id_visita.'&flag=s',['class'=>'btn btn-primary']) ?>

    <?= Html::a('<i class="fa fa-plus"></i>',Yii::$app->request->baseUrl.'/seguimiento-visita/create?id='.$id_visita,['class'=>'btn btn-primary pull-right']) ?>
        
    </div>

    <h2 style="text-align: center;">Seguimientos Visita <?= $id_visita ?></h2>
    ...
    <table class="table">
        ...
        <tbody>
             ...
             <?php foreach($seguimientos as $key):?>
