...
?>
    <tr>
       ...
       <td><?php
                echo Html::a('<i class="fa fa-pencil fa-fw"></i>',Yii::$app->request->baseUrl.'/rol/update?id='.$value['id'],['class'=>'btn btn-primary btn-sm']);
                echo Html::a('<i class="fa fa-plus fa-fw"></i>',Yii::$app->request->baseUrl.'/rol/permisos?id='.$value['id'],['title' => 'Agregar Permisos','class'=>'btn btn-info btn-sm']);
                echo Html::a('<i class="fa fa-remove"></i>',Yii::$app->request->baseUrl.'/rol/delete?id='.$value['id'],['data-method'=>'post','class'=>'btn btn-danger btn-sm']);
