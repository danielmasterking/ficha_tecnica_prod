...
<?= Html::a('<i class="fa fa-arrow-left"></i>',Yii::$app->request->baseUrl.'/informe-gestion/index?id='.$id,['class'=>'btn btn-primary']) ?>
    
</div>

<h2 style="text-align: center;">Añadir Informe de Gestión</h2>
