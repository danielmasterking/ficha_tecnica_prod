...
<?= Html::a('<i class="fa fa-arrow-left"></i>',Yii::$app->request->baseUrl.'/archivo-junta/index?id_junta='.$id_junta,['class'=>'btn btn-primary']) ?>
    
</div>

<h3 style="text-align: center">Visor Pdf</h3>
...
?>
<div id="scroller"  >
  <iframe src="http://docs.google.com/gview?url=<?php echo $file?>&embedded=true" width="100%" height="600px" scrolling="auto" > </iframe>
</div>
