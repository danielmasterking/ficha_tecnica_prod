 ...
 -->
        ...
        <!-- <div class="col-md-2">
            <ul class="nav nav-pills nav-stacked">
               ...
               <li class="active"><?php echo Html::a('<i class="fa fa-dot-circle-o fa-fw"></i>Permisos',Yii::$app->request->baseUrl.'/permiso/index');?></li>
               <?php endif;?>
...
<?php
  ...
  foreach ($permisos2 as $key => $value) {
?>
    <tr>
       ...
       <td><?php
                echo Html::a('<i class="fa fa-pencil fa-fw"></i>',Yii::$app->request->baseUrl.'/permiso/update?id='.$value['id'],['class'=>'btn btn-primary btn-sm']);
                echo Html::a('<i class="fa fa-remove"></i>',Yii::$app->request->baseUrl.'/permiso/delete?id='.$value['id'],['data-method'=>'post','class'=>'btn btn-danger btn-sm']);
