       ...
       <!--  <div class="col-md-2">
            <ul class="nav nav-pills nav-stacked">
              ...
              <li ><?php echo Html::a('<i class="fa fa-home fa-fw"></i>Home',Yii::$app->request->baseUrl.'/site/start');?></li>
               ...
               <li class="active"><?php echo Html::a('<i class="fa fa-dot-circle-o fa-fw"></i>Novedades',Yii::$app->request->baseUrl.'/novedad/index');?></li>
               <?php endif;?>
...
?>
    <tr>
       ...
       <td><?php
                echo Html::a('<i class="fa fa-pencil fa-fw"></i>',Yii::$app->request->baseUrl.'/novedad/update?id='.$value['id'],['class'=>'btn btn-primary btn-sm']);
                echo Html::a('<i class="fa fa-remove"></i>',Yii::$app->request->baseUrl.'/novedad/delete?id='.$value['id'],['data-method'=>'post','class'=>'btn btn-danger btn-sm']);
