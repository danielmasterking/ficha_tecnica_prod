...
<div class="col-md-12">
	...
	<h1 class="text-center">Adjuntar hoja de vida- <?= $nombre?></h1>
	    ...
	    <?= Html::submitButton($model->isNewRecord ? 'Adjuntar' : 'Actualizar', ['class' => $model->isNewRecord ? 'btn btn-primary' : 'btn btn-primary']) ?>
