...
<h3 style="text-align: center;">Reportes Diarios Realizados Por Coordinadores</h3>
...
<p>&nbsp;</p>
    ...
    if($total > 0){
      ...
      $tmp = array('REPORTES REALIZADOS',$val);
      $data [] = $tmp;
      $sin_realizar = $total - $total_realizado;
      $val = ($sin_realizar/$total) * 100;

      echo "<p>";
      echo "<strong>Total de Días: </strong>".$total;
      echo "</p>";
      echo "<p>";
      echo "<strong>Total de Reportes Diarios Realizado Por Coordinador ".$coord.": </strong>".$total_realizado;
      echo "</p>";
      
      $tmp = array('REPORTES SIN REALIZAR',$val);
      $data [] = $tmp;
      ...
      $string .= ']' ;
       ...
       echo Highcharts::widget([
                ...
                'options' => [
                    'title' => ['text' => 'Indicador de Reportes Diarios Por Coordinador'],
                    'plotOptions' => [
                        'pie' => [
                            'cursor' => 'pointer',
                        ],
...
echo Highcharts::widget([
    ...
    'options' => [
        ...
        'series' => [
            [
                'type' => 'column',
                'name' => 'Cantidad de Novedades por día',
                'data' => $label_cant,
            ],
