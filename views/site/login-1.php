...
<div class="container">
 <div id="loginbox" style="margin-top:5px;padding-top:5px;" class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">                    
   <div class="panel panel-info" style="border-color:#337ab7;">
                    <div class="panel-heading" style="background-color: #337ab7;color: white;border-color:#337ab7;">
                         ...
                         <div style="margin-bottom: 10px;width:100%;" class="input-group">
                                ...
                                <div style="margin-top:5px" class="form-group">
                                    ...
                                    <div class="col-sm-12 controls">
                                      ...
                                      <?= Html::submitButton('Ingresar', ['class' => 'btn btn-primary large', 'name' => 'login-button']) ?>
