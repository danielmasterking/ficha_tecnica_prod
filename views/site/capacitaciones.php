...
<h3 style="text-align: center;">Capacitaciones Realizadas Por Coordinadores</h3>
...
<p>&nbsp;</p>
    ...
    if($total > 0){
      ...
      echo "<p>";
      echo "<strong>Meta de Capacitaciones: </strong>".$total;
      echo "</p>";
      echo "<p>";
      echo "<strong>Total de Capacitaciones realizadas por Coordinador ".$coord.": </strong>".$total_realizado;
      echo "</p>";

      $tmp = array('CAPACITACIONES SIN REALIZAR %',$val);
      $data [] = $tmp;

      $string = '[';
      foreach ($consolidado as $key) {

        $can = $key['TOTAL_CAPACITACIONES'] * 1;

        $labels [] = $key['FECHA'];
        $label_cant [] = array($key['FECHA'],$can);

        $string .= $key['TOTAL_CAPACITACIONES'].',';
      ...
      $string .= ']' ;
       ...
       echo Highcharts::widget([
                ...
                'options' => [
                    'title' => ['text' => 'Indicador de Capacitaciones Por Coordinador'],
                    'plotOptions' => [
                        'pie' => [
                            'cursor' => 'pointer',
                        ],
...
echo Highcharts::widget([
    ...
    'options' => [
        ...
        'series' => [
            [
                'type' => 'column',
                'name' => 'Cantidad de Capacitaciones por día',
                'data' => $label_cant,
            ],
