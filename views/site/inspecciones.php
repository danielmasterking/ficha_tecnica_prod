...
<h3 style="text-align: center;">Inspecciones de Riesgo Realizadas Por Coordinadores</h3>
...
<p>&nbsp;</p>
    ...
    if($total > 0){
      ...
      $tmp = array('Capacitaciones Realizadas %',$val);
      $data [] = $tmp;
      ...
      echo "<p>";
      echo "<strong>Meta de Inspecciones de Seguridad: </strong>".$total;
      echo "</p>";
      echo "<p>";
      echo "<strong>Total de Inspecciones se seguridad realizadas por Coordinador ".$coord.": </strong>".$total_realizado;
      echo "</p>";

      $tmp = array('INSPECCIONES DE SEGURIDAD SIN REALIZAR %',$val);
      $data [] = $tmp;

      $string = '[';
      foreach ($consolidado as $key) {

        $can = $key['TOTAL_INSPECCIONES'] * 1;

        $labels [] = $key['FECHA'];
        $label_cant [] = array($key['FECHA'],$can);

        $string .= $key['TOTAL_INSPECCIONES'].',';
      ...
      $string .= ']' ;
       ...
       echo Highcharts::widget([
                ...
                'options' => [
                    'title' => ['text' => 'Indicador de Inspecciones de seguridad Por Coordinador'],
                    'plotOptions' => [
                        'pie' => [
                            'cursor' => 'pointer',
                        ],
...
echo Highcharts::widget([
    ...
    'options' => [
        ...
        'title' => [
            'text' => 'Inspecciones de Seguridad',
        ],
        'legend' => [
           'layout' => 'horizontal',
        ],
        ...
        'series' => [
            [
                'type' => 'column',
                'name' => 'Cantidad de Inspecciones de seguridad por día',
                'data' => $label_cant,
            ],
