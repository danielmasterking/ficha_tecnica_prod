...
<?= $this->render('_tabs',['empleados'=>'active']) ?>
   <h2>Empleados</h2>
...
?>
    <tr>
       <td><?php echo Html::a($value['NIT'],Yii::$app->request->baseUrl.'/site/detalleemp?id='.$value['NIT']);?></td>
       ...
       <td>
          <a class="btn btn-primary btn-xs"  href="<?= Yii::$app->request->baseUrl.'/site/hdv_empleado?id='.$value['NIT'].'&nombre='.$value['NOMBRE'] ?>">
            <i class="fa fa-file-archive-o" ></i> HDV
          </a>
       </td>
