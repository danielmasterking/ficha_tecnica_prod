...
<div class="col-md-12">
   ...
   <div class="form-group">
      ...
      <?= Html::a('<i class="fa fa-flag"> Festivos</i>',Yii::$app->request->baseUrl.'/festivo/create',['class'=>'btn btn-primary pull-right']) ?>
        
   </div>

     <h3 style="text-align: center;">Indicadores</h3>
    <div class="row">
        ...
        <div class="col-md-4">
           ...
           <div class="card">
                ...
                <div class="card-image">
                    ...
                    <a href="<?php echo Yii::$app->request->baseUrl.'/site/reportes';?>"><img class="img-responsive" src="<?php echo Yii::$app->request->baseUrl.'/img/indicadores.png';?>"></a>
                ...
                <div class="card-content">   
                  ...
                  <p>Reportes Diarios de Coordinadores</p>
        ...
        <div class="col-md-4">
           ...
           <div class="card">
                ...
                <div class="card-image">
                    ...
                    <a href="<?php echo Yii::$app->request->baseUrl.'/site/capacitaciones';?>"><img class="img-responsive" src="<?php echo Yii::$app->request->baseUrl.'/img/indicadores.png';?>"></a>
                ...
                <div class="card-content">   
                  ...
                  <p>Capacitaciones En puestos de vigilancia</p>
        ...
        <div class="col-md-4">
           ...
           <div class="card">
                ...
                <div class="card-image">
                    ...
                    <a href="<?php echo Yii::$app->request->baseUrl.'/site/visitastecnicasoperativas';?>"><img class="img-responsive" src="<?php echo Yii::$app->request->baseUrl.'/img/indicadores.png';?>"></a>
                ...
                <div class="card-content">   
                  ...
                  <p>Visitas Técnicas Operativas</p>
        ...
        <div class="col-md-4">
           ...
           <div class="card">
                ...
                <div class="card-image">
                    ...
                    <a href="<?php echo Yii::$app->request->baseUrl.'/site/inspecciones';?>"><img class="img-responsive" src="<?php echo Yii::$app->request->baseUrl.'/img/indicadores.png';?>"></a>
