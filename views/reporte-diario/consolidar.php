...
<h3 style="text-align: center;">Consolidado de Novedades</h3>
   ...
   <div class="col-md-3">
         ...
         <?php
          ...
          foreach ($novedades as $key ) {
              ...
              $data_novedad[$key->id] = $key->nombre; 
          }
          ...
          echo Select2::widget([
              ...
              'options' => [
                  'id' => 'novedad',
                  'placeholder' => 'Seleccione novedad'
...
<?php if(in_array('medicion-coord', $permisos)){
...
<p>&nbsp;</p>
    ...
    if($total > 0){
      ...
      foreach ($consolidado as $key) {
        ...
        $val = ($key['CANTIDAD']/$total) * 100;
        $can = $key['CANTIDAD'] * 1;
        
        $tmp = array($key['NOVEDAD'],$val);
        $data [] = $tmp;
        $labels [] = $key['NOVEDAD'];
        $label_cant [] = array($key['NOVEDAD'],$can);
    ...
    'options' => [
        ...
        'series' => [
            ...
            <table class="table">
               ...
               <tbody>
                 <?php $tamano_detalle = count($total_sucursales);$index_detalle = 0;$copia_detalle_consolidado = $detalle_consolidado;?>

                 <?php foreach($total_sucursales as $key):?>
                    <tr>
                       <td>
                         <?= $key['SUCURSAL'] ?>
                       </td>
                       ...
                       <td>
                         ...
                         <?php foreach($detalle_consolidado[$index_detalle] as $key2 => $val):?>
                               <?php //var_dump($val);?>
                               ...
                               <?php 
                                ...
                                //  if(array_key_exists($llave, $val)){

                                    echo '('.$detalle_consolidado[$index_detalle][$llave].') '.$llave.'</br>';  
                                  //}
                         ...
                         <?php $index_detalle = $index_detalle + 1;$detalle_consolidado = $copia_detalle_consolidado;?>
