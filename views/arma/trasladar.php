...
$data_armas = array();
foreach ($armas as $key ) {
  # code...
  $data_armas[$key->id] = $key->serie;
}
...
<!-- Validar permiso de administración de armas para poder moodificar datos básicos -->
  <?php if(in_array("adm-armas", $permisos)):?>
    <div class="bottom">
     ...
     <li role="presentation" class="active"><?php echo Html::a('Mover Armas',Yii::$app->request->baseUrl.'/arma/trasladar'); ?></li>
   </ul>
...
<?= Html::a('<i class="fa fa-arrow-left"></i>',Yii::$app->request->baseUrl.'/arma/index',['class'=>'btn btn-primary']) ?>
            ...
            <?php
                if(isset($message) && $message = "200"){
             ?>
                 <p class="alert alert-success">Arma Trasladada de forma satisfactoria.</p>
             <?php
                }
             ?>
            ...
            <?=
               ...
               $form->field($model, 'arma_id')->widget(Select2::classname(), [
               'data' => $data_armas,
            ...
            <div class="form-group">
                <?php
                  ...
                  foreach ($clientes as $key ) {
                      ...
                      $data_cliente[$key->nit] = $key->nombre;
                  }
