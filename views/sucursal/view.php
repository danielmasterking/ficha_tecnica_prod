...
<?= Html::a('<i class="fa fa-file-pdf-o"></i>',Yii::$app->request->baseUrl.'/consigna/index?id='.$id,['title' => 'Consignas','class'=>'btn btn-primary']) ?>
<?= Html::a('<i class="fa fa-exclamation-triangle"></i>',Yii::$app->request->baseUrl.'/factor-riesgo/index?id='.$id,['title' => 'Factores de Riesgo','class'=>'btn btn-primary']) ?>

<?= Html::a('<i class="fa fa-pencil"> Cambiar Imagen</i>',Yii::$app->request->baseUrl.'/sucursal/imagen?id='.$id,['class'=>'btn btn-primary pull-right']) ?>  

</div>   

<h3 style="text-align: center;">Información Sucursal</h3>
...
<div class="col-md-6">
  ...
  <?php $ruta = $model->image == null ? ' ' : $model->image;
...
<div class="col-md-6">
    ...
    <p ><strong>Sucursal:</strong> <?= $model->nombre?></p>
...
<div class="col-md-12">
  ...
  <h4 style="text-align: center;">Contactos</h4>

  <div class="form-group">

   <?= Html::a('<i class="fa fa-plus"></i>',Yii::$app->request->baseUrl.'/contacto/create?id='.$id,['class'=>'btn btn-primary pull-right']) ?>  
...
?>
    <tr>
       ...
       <td><?php
            //echo Html::a('<i class="fa fa-remove fa-fw"></i>',Yii::$app->request->baseUrl.'/contacto/delete?id='.$key->id, ['data' => ['method' => 'post']]);
            echo Html::a('<i class="fa fa-pencil fa-fw"></i>',Yii::$app->request->baseUrl.'/contacto/update?id='.$key->id, []);
            if(in_array("eliminar-contacto", $permisos)){
               
                echo Html::a('<i class="fa fa-remove fa-fw"></i>',Yii::$app->request->baseUrl.'/contacto/delete?id='.$key->id,[]);
