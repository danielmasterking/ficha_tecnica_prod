...
<?= Html::a('<i class="fa fa-arrow-left"></i>',Yii::$app->request->baseUrl.'/estudio-seguridad/index?id='.$sucursal_id,['class'=>'btn btn-primary']) ?>

<?= Html::a('<i class="fa fa-plus"></i>',Yii::$app->request->baseUrl.'/seguimiento-estudio/create?id='.$id,['class'=>'btn btn-primary pull-right']) ?>
    
</div>

<div class="row bottom">

    <h3 class="col-md-offset-4">Seguimientos Estudios de Seguridad</h3>
...
?>
    <tr>
       ...
       <td><?=$value->fecha?></td>
       <td><?=Html::a('<i class="fa fa-download fa-fw"></i>',Yii::$app->request->baseUrl.$value->archivo,['download' => 'seguimiento','title' => 'Descargar'])?></td>       
       <td><?=$value->observacion?></td>
       <td><?=Html::a('<i class="fa fa-remove fa-fw"></i>',Yii::$app->request->baseUrl.'/seguimiento-estudio/delete?id='.$value->id,['data-method' => 'post'])?></td></td>       
