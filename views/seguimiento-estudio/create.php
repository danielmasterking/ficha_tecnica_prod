...
<?= Html::a('<i class="fa fa-arrow-left"></i>',Yii::$app->request->baseUrl.'/seguimiento-estudio/index?id='.$id,['class'=>'btn btn-primary']) ?>


    
</div>

<h2 style="text-align: center;">Crear Seguimiento Estudio de Seguridad</h2>
