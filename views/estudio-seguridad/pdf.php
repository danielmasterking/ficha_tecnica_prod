...
<?= Html::a('<i class="fa fa-arrow-left"></i>',Yii::$app->request->baseUrl.'/sucursal/index?id='.$sucursal,['class'=>'btn btn-primary']) ?>
...
<iframe src="<?php echo $file?>" width="100%" height="360"> </iframe>
