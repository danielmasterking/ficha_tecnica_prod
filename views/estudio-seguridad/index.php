...
<?= Html::a('<i class="fa fa-plus"></i>',Yii::$app->request->baseUrl.'/estudio-seguridad/create?id='.$id,['class'=>'btn btn-primary pull-right']) ?>
    
</div>

<div class="row bottom">

    <h3 class="col-md-offset-4">Estudios de Seguridad</h3>
...
?>
    <tr>
       <td><?=Html::a('<i class="fa fa-remove fa-fw"></i>',Yii::$app->request->baseUrl.'/estudio-seguridad/empanada?id='.$value['id'])?>
         
         <?php
           
          /* echo \yii\helpers\Html::a('<i class="fa fa-remove fa-fw"></i>', \yii\helpers\Url::to(['estudio-seguridad/delete','id' => $value['id']]), [
              'data' => [
                  'confirm' => '¿Estás seguro de que deseas hacerlo?',
                  'method' => 'POST',
                  'params' => ['id' => $value['id']],
              ]
          ]);*/
       ...
       <td><?=Html::a('<i class="fa fa-plus fa-fw"></i>',Yii::$app->request->baseUrl.'/seguimiento-estudio/index?id='.$value['id'],['title' => 'Agregar Seguimiento'])?></td>       
