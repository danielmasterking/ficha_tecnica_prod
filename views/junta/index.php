      ...
      <?php endif;?>
       ...
       <!--  <div class="col-md-2">
            <ul class="nav nav-pills nav-stacked">
               ...
               <li class="active"><?php echo Html::a('<i class="fa fa-dot-circle-o fa-fw"></i>Juntas',Yii::$app->request->baseUrl.'/junta/index');?></li>
               <?php endif;?>
...
<?php if(in_array("adm-junta", $permisos)):?>   
<?= Html::a('<i class="fa fa-flag">Documentos vistos</i>',Yii::$app->request->baseUrl.'/historial-junta/index',['class'=>'btn btn-primary']) ?>
 <?php endif;?>  
<?php if(in_array("archivo-junta", $permisos)):?>   
<?= Html::a('<i class="fa fa-plus"></i>',Yii::$app->request->baseUrl.'/junta/create',['class'=>'btn btn-primary pull-right']) ?>
 <?php endif;?>
...
<div class="row bottom">
    ...
    <h3 style="text-align: center;">Juntas</h3>
...
<?php
  ...
  foreach ($juntas as  $value) {
?>
    <tr>
      <?php if(in_array("archivo-junta", $permisos)):?>   
      <td><?php 
         echo Html::a('<i class="fa fa-remove fa-fw"></i>',Yii::$app->request->baseUrl.'/junta/delete?id='.$value->id,['title' => 'Eliminar Junta','class'=>'btn btn-danger btn-sm']);
         echo Html::a('<i class="fa fa-pencil fa-fw"></i>',Yii::$app->request->baseUrl.'/junta/update?id='.$value->id,['title' => 'Actualizar Junta','class'=>'btn btn-primary btn-sm']);
         ?></td> 
      ...
      <?php endif;?>
      <td><?=$value->fecha?></td> 
      <td><?=Html::a($value->titulo,Yii::$app->request->baseUrl.'/archivo-junta/index?id_junta='.$value->id)?></td>   
      <td><?=$value->descripcion?></td>   
      <?php if(in_array("archivo-junta", $permisos)):?>   
      <td><?=Html::a('<i class="fa fa-plus fa-fw"></i>',Yii::$app->request->baseUrl.'/archivo-junta/create?id_junta='.$value->id,['title' => 'Agregar adjunto','class'=>'btn btn-success btn-sm'])?></td> 
      <?php else:?>
        <td></td>
      <?php endif;?> 
    </tr>
