...
<div class="preaviso-form check-form">
  ...
  <?php
       ...
       echo Html::a('<i class="fa fa-arrow-left fa-fw"></i>',Yii::$app->request->baseUrl.'/cliente/index', ['class' => 'btn btn-primary']);
       echo Html::a('<i class="fa fa-plus fa-fw"></i>',Yii::$app->request->baseUrl.'/unidad-negocio/create', ['class' => 'btn btn-primary pull-right']);
    ...
    <tr>
       ...
       <td>
          ...
          <?php 
              ...
              echo Html::a($key->nombre,Yii::$app->request->baseUrl.'/unidad-negocio/asignar?id='.$key->id);

          ?>

       </td>
       
       <td><?=$key->clienteName->nombre?></td>
