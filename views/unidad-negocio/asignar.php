...
$sucursales_asignadas = array();

foreach ($asignadas as $key ) {
   
   $sucursales_asignadas [] = $key->sucursal_id;
}
...
<div class="preaviso-form check-form">
  ...
  <?php
       ...
       echo Html::a('<i class="fa fa-arrow-left fa-fw"></i>',Yii::$app->request->baseUrl.'/unidad-negocio/index', ['class' => 'btn btn-primary']);
...
<input type="submit" class="btn btn-primary pull-right" value="Asignar" name="asignar">
...
?>
        ...
        <?php if(in_array($key->id, $sucursales_asignadas)):?>


              <tr>

                  <td><?= Html::checkBox('sucursales_array[]',true, ['value' => $key->id])?></td>
                  <td><?=$key->nombre?></td>
               </tr>
        ...
        <?php else:?>
              ...
              <tr>
                  ...
                  <td><?= Html::checkBox('sucursales_array[]',false, ['value' => $key->id])?></td>
                  <td><?=$key->nombre?></td>
               </tr>
