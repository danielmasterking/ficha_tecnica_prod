...
?>
    <tr>
       ...
       <td><?=$value['status']?></td>
       <td><?php
                echo Html::a('<i class="fa fa-pencil fa-fw"></i>',Yii::$app->request->baseUrl.'/usuario/update?id='.$value['usuario'],['class'=>'btn btn-primary btn-sm']);
                echo Html::a('<i class="fa fa-eye fa-fw"></i>',Yii::$app->request->baseUrl.'/usuario/view?id='.$value['usuario'],['class'=>'btn btn-info btn-sm']);
                echo Html::a('<i class="fa fa-user fa-fw"></i>',Yii::$app->request->baseUrl.'/usuario/clientes?id='.$value['usuario'],['title' => 'Asignar Clientes','class'=>'btn btn-success btn-sm']);
                echo Html::a('<i class="fa fa-building-o fa-fw"></i>',Yii::$app->request->baseUrl.'/usuario/sucursalesvarios?id='.$value['usuario'],['title' => 'Asignar Sucursal','class'=>'btn btn-primary btn-sm']);
                echo Html::a('<i class="fa fa-flag-o fa-fw"></i>',Yii::$app->request->baseUrl.'/usuario/meta?id='.$value['usuario'],['title' => 'Asignar Meta','class'=>'btn btn-success btn-sm']);
                echo Html::a('<i class="fa fa-remove"></i>',Yii::$app->request->baseUrl.'/usuario/delete?id='.$value['usuario'],['data-method'=>'post','class'=>'btn btn-danger btn-sm']);
