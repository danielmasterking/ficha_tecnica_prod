...
<div class="row">
 ...
 <?= Html::submitButton('Todas', ['class' => 'btn btn-primary pull-right','name'=>'todas']) ?>
<p class="col-md-1 pull-right"></p>
<?php echo Html::a('Sucursales/Ciudad',Yii::$app->request->baseUrl.'/usuario/sucursalesciudades?id='.$usuario,['class' => 'btn btn-primary pull-right']);?>
