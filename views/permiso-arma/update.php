...
<?= Html::a('<i class="fa fa-arrow-left"></i>',Yii::$app->request->baseUrl.'/permiso-arma/index',['class'=>'btn btn-primary']) ?>
    
</div>
    
   <h3 style="text-align: center;">Actualizar Permiso Arma</h3> 
    <?= $this->render('_form', [
        'model' => $model,
    ]) ?>
