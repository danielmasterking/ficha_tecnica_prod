...
<?= Html::a('<i class="fa fa-plus"></i>',Yii::$app->request->baseUrl.'/factor-riesgo/create?id='.$id,['class'=>'btn btn-primary pull-right']) ?>
    
</div>

<div class="row bottom">

    <h3 class="col-md-offset-4">Factores de Riesgo</h3>
...
?>
    <tr>
      <td><?=Html::a('<i class="fa fa-remove fa-fw"></i>',Yii::$app->request->baseUrl.'/factor-riesgo/empanada?id='.$value['id'],['data-method' => 'post'])?></td></td> 
       <td><?=$value['fecha']?></td>
