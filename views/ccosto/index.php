...
<?= Html::a('<i class="fa fa-plus"></i>',Yii::$app->request->baseUrl.'/ccosto/create',['class'=>'btn btn-primary']) ?>
    
</div>
<?php $form = ActiveForm::begin(['class' => 'check-form']); ?>
<table class="table display my-data">
...
?>
    <tr>
       ...
       <td><?=$value['nombre']?></td>
       <td><?php echo Html::a('<i class="fa fa-pencil"></i>',Yii::$app->request->baseUrl.'/ccosto/update?id='.$value['id'],['class'=>'btn btn-primary btn-sm']);
                 echo Html::a('<i class="fa fa-remove"></i>',Yii::$app->request->baseUrl.'/ccosto/delete?id='.$value['id'],['data-method'=>'post','class'=>'btn btn-danger btn-sm']);
                 echo Html::a('<i class="fa fa-plus"></i>',Yii::$app->request->baseUrl.'/ccosto/ciudades?id='.$value['id'],['class'=>'btn btn-success btn-sm']);
        ?></td>
